...
public class LauncherFrame extends DraggableFrame implements IRelocalizableResource, IAuthListener<MojangUser> {
    ...
    public static final Color COLOR_BLUE = new Color(73,75,140);
    public static final Color COLOR_BLUE_DARKER = new Color(67,70,126);
    ...
    public static final Color COLOR_BUTTON_BLUE = new Color(73,75,140);
