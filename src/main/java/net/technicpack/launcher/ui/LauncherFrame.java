...
public class LauncherFrame extends DraggableFrame implements IRelocalizableResource, IAuthListener<MojangUser> {
    ...
    public static final Color COLOR_GREEN = new Color(8,88,178);
    public static final Color COLOR_BLUE = new Color(130,183,104);
    public static final Color COLOR_BLUE_DARKER = new Color(99,167,80);
    ...
    public static final Color COLOR_BUTTON_BLUE = new Color(99,167,80);
