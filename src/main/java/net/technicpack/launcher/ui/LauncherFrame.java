...
public class LauncherFrame extends DraggableFrame implements IRelocalizableResource, IAuthListener<MojangUser> {
    ...
    public static final Color COLOR_GREEN = new Color(16, 108, 163);
    public static final Color COLOR_BLUE = new Color(49,54,111);
    public static final Color COLOR_BLUE_DARKER = new Color(40,44,102);
    ...
    public static final Color COLOR_BUTTON_BLUE = new Color(49,54,111);
    ...
    private void initComponents() {
        ...
        headerLabel.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                DesktopUtils.browseUrl("https://craftnetwork.eu.org/");
            }
        });
