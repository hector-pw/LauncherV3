...
public class LauncherFrame extends DraggableFrame implements IRelocalizableResource, IAuthListener<MojangUser> {
    ...
    public static final Color COLOR_BLUE = new Color(14,67,182);
    public static final Color COLOR_BLUE_DARKER = new Color(7,54,142);
    ...
    public static final Color COLOR_BUTTON_BLUE = new Color(14,67,182);
